...
const Navbar = () => {
    ...
    const menuItems = <React.Fragment>
        ...
        {
            user?.uid ? <li className='font-semibold text-white bg-red-700 rounded-lg'><Link to="/login">Sign Out</Link></li> : <li className='font-semibold'><Link to="/login">Login</Link></li>
        }
    </React.Fragment>
